...
mailwidget:buttons(awful.util.table.join(
  awful.button({ }, 1, function () exec("rxvt -T Alpine -e alpine_exp") end)
))
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "w", function () exec("iceweasel") end),
    awful.key({ altkey }, "F1",  function () exec("rxvt -e /bin/zsh") end),
    awful.key({ altkey }, "#49", function () scratch.drop("rxvt", "bottom") end),
    awful.key({ modkey }, "a", function () exec("rxvt -T Alpine -e alpine_exp") end),
    ...
    awful.key({ altkey }, "F4", function ()
        awful.prompt.run({ prompt = "Web: " }, promptbox[mouse.screen].widget,
            function (command)
                sexec("iceweasel 'http://yubnub.org/parser/parse?command="..command.."'")
